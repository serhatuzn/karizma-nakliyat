...
import { PhoneCall, Mail, Truck, Shield, Award, CheckCircle, FileCheck, Globe, Briefcase } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-center relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              20 yılı aşkın tecrübemizle Türkiye'nin ve dünyanın her noktasına güvenilir taşımacılık hizmeti sunuyoruz.
            </p>
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <div className="text-sm md:text-base text-blue-100">Yıllık Tecrübe</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold">5000+</div>
                <div className="text-sm md:text-base text-blue-100">Başarılı Taşıma</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold">20+</div>
                <div className="text-sm md:text-base text-blue-100">Uzman Personel</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold">30+</div>
                <div className="text-sm md:text-base text-blue-100">Araç Filosu</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Karizma Nakliyat olarak müşterilerimize kapsamlı lojistik ve taşımacılık çözümleri sunuyoruz.
            </p>
          </div>
            ...
            <div className="group bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  Türkiye'nin 81 iline güvenli ve hızlı taşımacılık hizmeti. Özel araç filomuz ve uzman ekibimizle
                  eşyalarınız güvende.
                </p>
                <Link
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">Neden Bizi Seçmelisiniz?</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Karizma Nakliyat olarak müşteri memnuniyetini en üst seviyede tutmak için çalışıyoruz.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                20 yılı aşkın sektör tecrübemizle, lojistik alanında uzmanlaşmış kadromuz ve modern araç filomuzla
                hizmetinizdeyiz.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Tüm taşımacılık operasyonlarımız sigorta kapsamındadır. Eşyalarınız bizimle %100 güvende.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                K1, K2, C2 ve diğer tüm gerekli yetki belgelerine sahibiz. Yasal gereklilikler konusunda endişelenmeyin.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Uzman ve deneyimli personelimiz, taşıma sürecinin her aşamasında profesyonel hizmet sunar.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">Karizma Nakliyat Hakkında</h2>
              <p className="text-lg text-gray-600 mb-6">
                2000 yılında kurulan Karizma Nakliyat, lojistik sektöründe güvenilir ve kaliteli hizmet anlayışıyla öne
                çıkan bir markadır. Müşteri memnuniyetini her zaman ön planda tutan firmamız, yılların verdiği tecrübe
                ile sektörde lider konumdadır.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Modern araç filomuz, uzman kadromuz ve teknolojik altyapımız ile ev ve ofis taşımacılığından
                uluslararası lojistik çözümlere kadar geniş bir hizmet yelpazesi sunuyoruz.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">Referanslarımız</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Yıllar içinde birçok saygın kurum ve kuruluşa hizmet verdik. İşte bize güvenen markalardan bazıları:
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="text-white">
                ...
                <p className="text-lg mb-6 opacity-90">
                  Taşıma ihtiyaçlarınız için ücretsiz keşif ve fiyat teklifi alın. Uzman ekibimiz size en uygun çözümü
                  sunacaktır.
                </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <h3 className="text-xl font-bold mb-4 text-gray-800">Teklif Formu</h3>
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="sehirlerarasi">Şehirlerarası Taşımacılık</option>
